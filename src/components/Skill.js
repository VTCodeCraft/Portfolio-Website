...
export default function Skill() {
  ...
  const skills = {
    technical: [
      { name: "HTML", prof: 80 },
      { name: "CSS", prof: 65 },
      { name: "JavaScript", prof: 75 },
      { name: "ReactJS", prof: 40 },
      { name: "Node.js", prof: 60 },
      { name: "Express.js", prof: 60 },
      { name: "Tailwind CSS", prof: 50 },
      { name: "MongoDB & Mongoose", prof: 60 },
      { name: "Java", prof: 60 }, // approximate beginner-intermediate
      { name: "C / C++", prof: 60 }, // approximate beginner-intermediate
      { name: "Python", prof: 60 }, // approximate beginner-intermediate
      { name: "MySQL", prof: 60 },
      { name: "DSA (Java)", prof: 40 },
    ],
    soft: [
